...
<div class="theme-selector">
	...
	>
		<svg width="22" height="22" viewBox="0 0 325.04 325.04" fill="currentColor" opacity="0.8">
			<g>
...
<style>
	...
	.theme-toggle {
		background: linear-gradient(135deg, var(--theme-primary, rgba(70, 130, 180, 0.9)) 0%, var(--theme-primary-dark, rgba(70, 130, 180, 1)) 100%);
	...
	.theme-toggle::before {
		...
		right: -2px;
		bottom: -2px;
		background: linear-gradient(45deg, var(--theme-primary-light, rgba(173, 216, 230, 0.2)), var(--theme-primary, rgba(70, 130, 180, 0.9)), var(--theme-primary-dark, rgba(70, 130, 180, 1)));
		border-radius: 14px;
		z-index: -1;
		opacity: 0;
	...
	.theme-option.active {
		background: var(--theme-primary-light, rgba(173, 216, 230, 0.2));
		color: var(--theme-primary-dark, rgba(70, 130, 180, 1));
		font-weight: 500;
	}
